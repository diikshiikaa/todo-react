...
const App = () => {
  ...
  const handleDeleteTodo = (index) => {
    ...
    reducedTodo.splice(index, 1); // Fix: use splice(index, 1) to delete the correct item
  ...
  const handleUpdateToDo = () => {
    ...
    setTodos(newToDo);
    setCurrentEdit("");
    localStorage.setItem("todolist", JSON.stringify(newToDo)); // Save updates to local storage
  };
      ...
      <div className="todo-wrapper">
        ...
        <div className="btn-area">
          ...
          <div className="filter-wrapper">
            <div id="search" className="todo-input-item ">
